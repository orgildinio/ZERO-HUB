...
import { Store, Home, Search, Mail, ArrowLeft, RefreshCw, Clock, Shield } from "lucide-react"
...
export function StoreNotFoundPage() {
    ...
    const quickActions = [
        ...
        },
        {
            ...
            description: "Explore our template store",
            href: "/templates",
            primary: false,
        },
    ]
    ...
    const reasons = [
        {
            ...
            description: "The store might be undergoing scheduled maintenance",
        },
        {
            icon: <Shield className="h-5 w-5 text-blue-400" />,
            title: "Access Restrictions",
            description: "Your account may not have access to this store",
        },
        {
            icon: <Search className="h-5 w-5 text-green-400" />,
            title: "Store Moved",
            description: "The store URL may have changed or been updated",
        },
    ]
                ...
                <div className="container relative z-10 px-4">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            >
                                <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Store Unavailable</h1>
                                <p className="text-xl text-zinc-400 max-w-2xl mx-auto mb-8">
                                    The store you&apos;re trying to access is currently unavailable. This could be temporary.
                                </p>
                            </motion.div>
                            <motion.div
                            ...
                            >
                                <div className="text-center mb-8">
                                    ...
                                    <p className="text-zinc-400">Here are some common reasons</p>
                                </div>
                            ...
                            >
                                ...
                                <p className="text-zinc-400 mb-6 max-w-2xl mx-auto">
                                    If you believe this is an error or need immediate help accessing a specific store, our support team is
                                    here to assist you.
                                </p>
