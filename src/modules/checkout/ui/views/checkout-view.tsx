                                    ...
                                    {data?.docs.map((product) => (
                                        <div key={product.id} className="flex gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-gray-500">${product.pricing.compareAtPrice} each</p>
                                            </div>
                                            <div className="text-right">
                                                <p className="font-medium">${(product.pricing?.compareAtPrice ? product.pricing.compareAtPrice : product.pricing.price * getProductQuantity(product.id)).toFixed(2)}</p>
                                            </div>
                                        </div>
                                    ))}
                                    <Separator />
