...
export const CategoryHero = ({ name, description, image, productCount, featured }: Props) => {
    return (
            ...
            <div className="container px-2 py-16 md:px-6 md:py-24 mx-auto">
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
                    <div className="relative z-10">
                        ...
                        <p className="text-xl text-stone-600 mb-8 leading-relaxed max-w-lg">{description}</p>
                        ...
                        <div className="grid grid-cols-3 gap-6 text-center">
                            <div className="p-4 rounded-lg bg-white/60 backdrop-blur-sm">
                                <div className="text-2xl font-bold text-stone-900">{productCount}</div>
